...
const EMPRESA_INFO = {
    ...
    descripcion: "Centro especializado en reforzamiento académico",
    ...
    return (
        <div className="reservas-page">
            <div className="reservas-grid">
                {/* Primera columna: Información de la empresa y profesores */}
                <div className="columna-info">
                    <div className="empresa-info">
                        <h1>{EMPRESA_INFO.nombre}</h1>
                        <p>{EMPRESA_INFO.descripcion}</p>
                        <div className="contacto">
                            <span>📍 {EMPRESA_INFO.direccion}</span>
                            <span>📞 {EMPRESA_INFO.telefono}</span>
                        </div>
                    </div>
